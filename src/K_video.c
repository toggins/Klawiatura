    ...
    [FNT_MAIN] = {
        ...
        .glyphs = {
            ...
            ['5'] =
                {
                    .size = {11, 24},
                    .uvs = {16.0f / 256.0f, 26.0f / 256.0f, 27.0f / 256.0f, 51.0f / 256.0f},
                },
            ['6'] =
                {
                    .size = {12, 24},
                    .uvs = {29.0f / 256.0f, 26.0f / 256.0f, 41.0f / 256.0f, 51.0f / 256.0f},
                },
            ['7'] =
                {
                    .size = {12, 24},
                    .uvs = {43.0f / 256.0f, 26.0f / 256.0f, 55.0f / 256.0f, 51.0f / 256.0f},
                },
            ['8'] =
                {
                    .size = {13, 24},
                    .uvs = {57.0f / 256.0f, 26.0f / 256.0f, 70.0f / 256.0f, 51.0f / 256.0f},
                },
            ['9'] =
                {
                    .size = {12, 24},
                    .uvs = {72.0f / 256.0f, 26.0f / 256.0f, 84.0f / 256.0f, 51.0f / 256.0f},
                },
            [':'] =
                {
                    .size = {7, 24},
                    .uvs = {86.0f / 256.0f, 26.0f / 256.0f, 93.0f / 256.0f, 51.0f / 256.0f},
                },
            [';'] =
                {
                    .size = {8, 24},
                    .uvs = {95.0f / 256.0f, 26.0f / 256.0f, 103.0f / 256.0f, 51.0f / 256.0f},
                },
            ['<'] =
                {
                    .size = {15, 24},
                    .uvs = {105.0f / 256.0f, 26.0f / 256.0f, 120.0f / 256.0f, 51.0f / 256.0f},
                },
            ['='] =
                {
                    .size = {15, 24},
                    .uvs = {122.0f / 256.0f, 26.0f / 256.0f, 137.0f / 256.0f, 51.0f / 256.0f},
                },
            ['>'] =
                {
                    .size = {16, 24},
                    .uvs = {139.0f / 256.0f, 26.0f / 256.0f, 155.0f / 256.0f, 51.0f / 256.0f},
                },
            ['?'] =
                {
                    .size = {12, 24},
                    .uvs = {157.0f / 256.0f, 26.0f / 256.0f, 169.0f / 256.0f, 51.0f / 256.0f},
                },
            ['@'] =
                {
                    .size = {23, 24},
                    .uvs = {171.0f / 256.0f, 26.0f / 256.0f, 194.0f / 256.0f, 51.0f / 256.0f},
                },
            ['A'] =
                {
                    .size = {12, 24},
                    .uvs = {196.0f / 256.0f, 26.0f / 256.0f, 208.0f / 256.0f, 51.0f / 256.0f},
                },
            ['B'] =
                {
                    .size = {12, 24},
                    .uvs = {210.0f / 256.0f, 26.0f / 256.0f, 222.0f / 256.0f, 51.0f / 256.0f},
                },
            ['C'] =
                {
                    .size = {12, 24},
                    .uvs = {224.0f / 256.0f, 26.0f / 256.0f, 236.0f / 256.0f, 51.0f / 256.0f},
                },
            ['D'] =
                {
                    .size = {13, 24},
                    .uvs = {238.0f / 256.0f, 26.0f / 256.0f, 251.0f / 256.0f, 51.0f / 256.0f},
                },
            ['E'] =
                {
                    .size = {11, 24},
