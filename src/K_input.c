...
Bindings BINDS[KB_SIZE] = {
	...
	[KB_SECRET_F] = {"F", KEY(F), NO_GAMEPAD},
	[KB_SECRET_I] = {"I", KEY(I), NO_GAMEPAD},
	[KB_SECRET_K] = {"K", KEY(K), NO_GAMEPAD},
	[KB_SECRET_N] = {"N", KEY(N), NO_GAMEPAD},
	[KB_SECRET_R] = {"R", KEY(R), NO_GAMEPAD},
