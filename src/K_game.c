...
extern const GameActorTable TAB_PLAYER_SPAWN, TAB_PLAYER, TAB_PLAYER_DEAD, TAB_CLOUD, TAB_BUSH, TAB_SOLID,
	...
	TAB_COIN_BLOCK, TAB_NOTE_BLOCK, TAB_BLOCK_BUMP, TAB_PSWITCH, TAB_MUSHROOM, TAB_MUSHROOM_1UP,
	TAB_MUSHROOM_POISON, TAB_STARMAN, TAB_AUTOSCROLL, TAB_BOUNDS, TAB_CHECKPOINT, TAB_PLATFORM, TAB_PLATFORM_TURN,
	TAB_EXPLODE;
static const GameActorTable* const ACTORS[ACT_SIZE] = {
	...
	[ACT_MUSHROOM] = &TAB_MUSHROOM,
	[ACT_MUSHROOM_1UP] = &TAB_MUSHROOM_1UP,
	[ACT_MUSHROOM_POISON] = &TAB_MUSHROOM_POISON,
	...
	[ACT_PLATFORM] = &TAB_PLATFORM,
	[ACT_PLATFORM_TURN] = &TAB_PLATFORM_TURN,
	[ACT_EXPLODE] = &TAB_EXPLODE,
};
