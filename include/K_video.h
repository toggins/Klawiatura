...
#define B_U4X4_F4X4(f4)                                                                                                \
    B_U4X4({f4[0][0] * 255.f, f4[0][1] * 255.f, f4[0][2] * 255.f, f4[0][3] * 255.f},                                   \
        {f4[1][0] * 255.f, f4[1][1] * 255.f, f4[1][2] * 255.f, f4[1][3] * 255.f},                                      \
        {f4[2][0] * 255.f, f4[2][1] * 255.f, f4[2][2] * 255.f, f4[2][3] * 255.f},                                      \
        {f4[3][0] * 255.f, f4[3][1] * 255.f, f4[3][2] * 255.f, f4[3][3] * 255.f})
#define B_U4X4_WHITE B_U4X4({248, 248, 248, 255}, {232, 232, 232, 255}, {232, 232, 232, 255}, {160, 160, 160, 255})
#define B_U4X4_GRAY B_U4X4({200, 200, 200, 255}, {150, 150, 150, 255}, {139, 134, 129, 255}, {119, 119, 119, 255})
