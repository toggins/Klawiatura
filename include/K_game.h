...
enum {
    ...
    ACT_WHEEL,
    ACT_WHEEL_R,
    ACT_SPIKE_BALL_CANNON,
    ACT_SPIKE_BALL_PROJECTILE,
    ACT_SPIKE_BALL_EFFECT,
    ACT_PORTRAIT_EYES,
    ACT_RISING_LAVA,
    ACT_FLAMETHROWER,
    ACT_FLAME_PROJECTILE,
    ACT_VOMIT_PROJECTILE,
    ACT_VOMIT_EFFECT,
    ACT_PEACH,
    ACT_PEACH_CAGE,
    ACT_PEACH_CAGE_SHARD,
    ACT_TEST_TUBE_CLONE,
    ACT_TEST_TUBE_BUBBLES,
    ACT_TEST_TUBE_BUBBLE,
    ACT_CLONE,
    ACT_JAWS_CLONE,
    ACT_BIG_CLONE,
    ACT_CODER_CLONE,
