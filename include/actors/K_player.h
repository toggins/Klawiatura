...
#define FLG_PLAYER_RESPAWNING CUSTOM_FLAG(5)
#define FLG_PLAYER_ASCEND CUSTOM_FLAG(6)
#define FLG_PLAYER_DESCEND CUSTOM_FLAG(7)
#define FLG_PLAYER_WEAPON CUSTOM_FLAG(8)
