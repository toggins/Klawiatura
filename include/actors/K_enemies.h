...
enum {
    ...
    VAL_DEAD_TYPE = MAX_VALUES - 1,
    VAL_DEAD_FRAME = MAX_VALUES - 2,
    VAL_DEAD_RESPAWN = MAX_VALUES - 3,
};
...
Bool check_stomp(GameActor*, GameActor*, Fixed, Sint32, Bool), maybe_hit_player(GameActor*, GameActor*);
